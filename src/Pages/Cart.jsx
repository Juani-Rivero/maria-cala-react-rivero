          ...
          <div className="row">
            ...
            <div className="col mb-2">
              <div className="row mb-5">
                <form>
                  <div class="mb-3">
                    <label htmlFor="name" class="form-label">Nombre y Apellido</label>
                    <input onInput={e => setName(e.target.value)} type="text" class="form-control" name="name" id="name" placeholder="Juan Doe" />
                  </div>
                  <div class="mb-3">
                    <label htmlFor="exampleInputEmail1" class="form-label">E-mail</label>
                    <input onInput={e => setEmail(e.target.value)} type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="juan@gmail.com" name="email" />
                    <div id="emailHelp" class="form-text">Nunca compartiremos esta información con nadie.</div>
                  </div>
                  <div class="mb-3">
                    <label class="form-check-label" htmlFor="phone">Teléfono</label>
                    <input onInput={e => setPhone(e.target.value)} type="tel" class="form-control" name="phone" id="phone" placeholder="3413123456" />
                  </div>
                </form>
              </div>
              <div className="row">
                <div className="col-sm-12  col-md-6">
                  <Link to={`/`}>
                    <button className="btn btn-block btn-secondary">Continuar Comprando</button>
                  </Link>
                </div>
